                      ...
                      <li>
                       <div class="wow slideInUp animated tercero" >
                        ...
                        <a href="#">
                          ...
                          <li>
                       <div class="wow slideInUp animated cuarto" >
                        <div class="image_title">
          ...
          <div class="row">
            ...
            <ul class="project-wrapper wow animated fadeInUp">
              ...
              <li class="portfolio-item wow slideInUp animated primero" id="lista1" >
                <img src="images/islap1chicaarriba.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry." >
                <figcaption class="mask" id="mascara1" >
                  <h4><?php echo $fraganciasfinas2 ?></h4>     <br>
                  <p >Buscamos ofrecerle al cliente la mas alta calidad de la fragancia creada. </p>
              ...
              <li class="portfolio-item wow slideInUp animated segundo" id="lista2">
                <img src="images/islap3chicaarriba.jpg" class="img-responsive" alt="Lorem Ipsum is simply dummy text of the printing and typesetting ndustry." >
                <figcaption class="mask" id="mascara2">
                  <h4 ><?php echo $cuidadopersonal2 ?></h4>
                  <br>
                  <p  >Asumimos el compromiso de ofrecerle al consumidor producto que al momento de percibir los aromas pueda disfrutar </p>
                  <a href="fragancias"> 
              ...
              <li class="portfolio-item wow slideInUp animated tercero" id="lista3" >
                ...
                <figcaption class="mask" id="mascara3" >
                  ...
                  <p>Ofrecemos productos que estan relacionados con la sensacion de seguridad, confort, pertenencia y calma. </p>
                 <a href="fragancias"> <img src="images/40.png" class="nube" ></a>
                </figcaption>
              ...
              <li class="portfolio-item wow slideInUp animated cuarto" id="lista4" >
                ...
                <figcaption class="mask" id="mascara4" >
                  ...
                  <p >Buscamos que el bienestar generado remita la tranquilidad de percibir un hogar limpio </p>
                  <a href="fragancias"> 
                   <img src="images/40.png" class="nube" ></a>
                </figcaption>
...
<div id="priemr_cuadrado">
                    ...
                    <section id="cuadrado">
                      <div class="wow zoomIn animated primero_cuadrado " >
                          <div class="wow zoomIn animated segundo_cuadrado"  >
                              <h4 ><?php echo $segundo_cuadrado1 ?><br><font style="color: #DA504B;"><?php echo $segundo_cuadrado2 ?></font></h4>
                          </div>
                      </div>
                    </section>
                  </div>
      ...
      <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.9s" style="height: 300px;" >
