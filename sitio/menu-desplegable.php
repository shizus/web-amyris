<div id="menu-desplegable" style="display: none">
  ...
  <div class="container-fluid visible-sm visible-xs hidden-lg hidden-md">
    ...
    <div class="row">
      <div class="col-sm-12 fragancias-nav-container center">
      <img src="images/flor-menu.png">
        <h1 class="nav-bar-title">
            <a href="fragancias">Fragancias</a>
        </h1>
    ...
    <div class="row">
      <div class="col-sm-12 expertise-nav-container center">
      <img src="images/flor-menu.png">
        <h1 class="nav-bar-title">
            <a href="expertise">Expertise</a>
        </h1>
    ...
    <div class="row">
      <div class="col-sm-12 sustentabilidad-nav-container center">
      <img src="images/flor-menu.png">
        <h1 class="nav-bar-title">
            <a href="sustentabilidad">Sustentabilidad</a>
        </h1>
    ...
    <div class="row">
      <div class="col-sm-12 innovaciones-nav-container center">
      <img src="images/flor-menu.png">
        <h1 class="nav-bar-title">
            <a href="innovaciones">Innovaciones</a>
        </h1>
